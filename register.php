...
if (isset($_POST["signUp"])){
    ...
    if(mysqli_query($con, $sql)){
        ...
        $message .= '<p style="font-size:18px;margin-left: 15px; margin-bottom: 28px;">Your account was created successfully! Please click on the following button to verify the account.</p>';
        ...
        $subject = 'Account Created | TeachMeHow';
